...
void RoofController::setup()
{
    Serial.println(F("[CONTROLLER] Setting up roof"));
...
void RoofController::onMessageReceived(const String &topic, const String &payload)
{
...
void RoofController::device_payload(String &destination)
{
